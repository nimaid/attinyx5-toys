...
// Adapted by Ella Jameson to allow preserving fuses if desired

// Default fuse configuration
#define  HFUSE  0xDF   // Defaults for ATtiny25/45/85
#define  LFUSE  0x62

#define RESET_HFUSE_BIT 7  // Which bit determines RESET or GPIO function (0-indexed)
#define RESET_ENABLED 1    // What to set the bit to to enable reset functionality
